...
zypper -R $target addrepo -G --refresh "http://mirrors.oit.uci.edu/centos/8-stream/BaseOS/x86_64/os/"         "baseos"
zypper -R $target addrepo -G --refresh "http://mirrors.oit.uci.edu/centos/8-stream/AppStream/x86_64/os/"         "appstream"
...
PARAMS=(
    passwd less vim-minimal grub2 kernel dhcp-client e2fsprogs microdnf strace
